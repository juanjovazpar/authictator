export const LITERALS = {
  ...
  ASSOCIATED_PERMISSION_ERROR:
    'This permission is associated to active roles. Unassign this permission from roles before deleting.',
  ...
  ROLE_ASSIGNED_ERROR:
    'This role is assigned to active users. Unassign this role from users before deleting.',
